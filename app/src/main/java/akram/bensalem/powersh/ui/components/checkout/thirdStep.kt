...
fun thirdStep(
    ...
    )
    {
        ...
        Modifier
            ...
            ConfirmAlertDialog(openDialog = openDialog, orderItem = orderItem ,onConfirmClicked = onConfirmClicked)
            ...
            Card(
                ...
                LazyColumn (
                    modifier = Modifier.padding(start = Dimens.SmallPadding.size, end = Dimens.SmallPadding.size),
